	...
	<form id="contact-form" action="<?php echo JRoute::_('index.php'); ?>" method="post" class="form-validate form-horizontal">
		<fieldset class="container-fluid">
			...
			<?php if ($this->params->get('show_email_copy')) : ?>
				<div class="pull-left">
					<div class="controls pull-left"><?php echo $this->form->getInput('contact_email_copy'); ?></div>
...
(function($){
	// $(document).ready(function() {
		$('#jform_contact_name').attr('placeholder', 'Nome');
		$('#jform_contact_email').attr('placeholder', 'E-mail');
		$('#jform_contact_emailmsg').attr('placeholder', 'Assunto');
		$('#jform_contact_message').attr('placeholder', 'Mensagem');
	// });
})(jQuery);
</script>